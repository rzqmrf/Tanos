                        ...
                        <td class="py-3.5 px-3 text-center whitespace-nowrap">
                            <div class="inline-flex items-center space-x-1.5">
                                ...
                                <a href="{{ route('material.outline-agreement.show', $item->id) }}"
                                   ...
                                   class="p-2 rounded-lg hover:opacity-90 transition shadow-2xs flex items-center justify-center" title="View Agreement">
                                ...
                                <a href="{{ route('material.outline-agreement.edit', $item->id) }}"
                                   ...
                                   class="p-2 rounded-lg hover:opacity-90 transition shadow-2xs flex items-center justify-center" title="Edit Agreement">
                                ...
                                <form action="{{ route('material.outline-agreement.destroy', $item->id) }}" method="POST" class="inline"
                                    ...
                                    <button type="submit" 
                                            ...
                                            class="p-2 rounded-lg hover:opacity-90 transition shadow-2xs flex items-center justify-center cursor-pointer" title="Delete Agreement">
