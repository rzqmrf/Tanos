                    ...
                    <tr class="hover:bg-slate-50/70 dark:hover:bg-slate-800/40 transition">
                        ...
                        <td class="py-3.5 px-3 text-center whitespace-nowrap">
                            <div class="inline-flex items-center space-x-1.5">
                                <!-- View (Blue/Sky) -->
                                <a href="{{ route('material.outline-agreement.show', $item->id) }}"
                                   class="p-2 rounded-lg bg-sky-500 hover:bg-sky-600 text-white transition shadow-2xs flex items-center justify-center" title="View Agreement">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                                </a>

                                <!-- Edit (Purple) -->
                                <a href="{{ route('material.outline-agreement.edit', $item->id) }}"
                                   class="p-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white transition shadow-2xs flex items-center justify-center" title="Edit Agreement">
                                ...
                                <form action="{{ route('material.outline-agreement.destroy', $item->id) }}" method="POST" class="inline"
                                    ...
                                    @method('DELETE')
                                    <button type="submit" 
                                            class="p-2 rounded-lg bg-rose-600 hover:bg-rose-700 text-white transition shadow-2xs flex items-center justify-center cursor-pointer" title="Delete Agreement">
