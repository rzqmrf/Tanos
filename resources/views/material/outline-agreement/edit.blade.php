        ...
        <form action="{{ route('material.outline-agreement.update', $agreement->id) }}" method="POST" class="space-y-6 text-xs">
            ...
            <div>
                ...
                <textarea name="notes" rows="3"
                          class="w-full p-3.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-800 dark:text-slate-100 focus:outline-none leading-relaxed">{{ old('notes', $agreement->notes) }}</textarea>
            </div>
