@props([
    'title',
    'module' => 'Modul Sistem',
    'description' => 'Modul ini sedang dalam tahap pengembangan dan integrasi sistem oleh tim pengembang. Fitur akan segera tersedia.'
])

@extends('layouts.app')

@section('title', $title . ' — Tanos ERP')
...
<div class="flex flex-col items-center justify-center min-h-[500px] bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 rounded-xl p-8 shadow-sm text-center">
    <div class="relative mb-6">
        ...
        <div class="relative p-5 bg-primary-light text-primary rounded-xl inline-block animate-pulse">
    ...
    <p class="text-xs font-bold text-amber-500 mb-4 bg-amber-50 dark:bg-amber-950/30 border border-amber-200/50 dark:border-amber-900/40 px-3 py-1 rounded-lg inline-block">
