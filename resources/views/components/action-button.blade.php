...
@php
    $baseClasses = "p-2 rounded-lg text-white transition shadow-2xs inline-flex items-center justify-center cursor-pointer border-0";
    
    $typeClasses = match($type) {
        'view' => 'bg-sky-500 hover:bg-sky-600',
    ...
    $buttonTitle = $title ?? $defaultTitle;
@endphp
