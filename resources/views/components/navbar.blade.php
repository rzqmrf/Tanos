...
<header class="sticky top-0 bg-[#f8fafc]/80 dark:bg-slate-950/80 backdrop-blur-md border-b border-slate-100 dark:border-slate-900 z-30 px-6 py-4 flex items-center justify-between transition-colors duration-300">
    ...
    <div class="flex items-center space-x-3 lg:space-x-4">
        ...
        <!-- Notification Button -->
        <button class="relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-2 rounded-xl text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:border-slate-300 dark:hover:border-slate-700 shadow-sm transition-all duration-200">
            <!-- Bell Icon -->
        ...
        <!-- User Profile Button -->
        <button class="flex items-center space-x-2 border border-slate-200 dark:border-slate-800 p-0.5 rounded-full hover:border-slate-300 dark:hover:border-slate-700 transition-all duration-200">
            <!-- User Icon (or Profile Picture) -->
            <div class="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-900 flex items-center justify-center text-slate-500 dark:text-slate-400 font-semibold text-sm">
                <!-- User Circle Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-slate-400 dark:text-slate-500">
