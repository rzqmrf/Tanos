...
<div class="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-100 dark:border-slate-800/80 shadow-[0_4px_20px_-3px_rgba(0,0,0,0.02)] hover:shadow-[0_10px_25px_-5px_rgba(0,0,0,0.04)] transition-shadow duration-300 flex flex-col justify-between h-full overflow-hidden w-full min-w-0">
