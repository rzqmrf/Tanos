...
@section('title', 'User - Create — Tanos ERP')
...
<div class="space-y-6" x-data="{
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-1.5 font-medium">
                Create New User Account & Assign Role Group.
            </p>
        </div>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-sm p-6 sm:p-8 space-y-6">
        ...
        <form action="{{ route('users.store') }}" method="POST" class="space-y-5 text-xs">
            @csrf
            ...
            <div class="space-y-4 max-w-4xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-2">
                    ...
                    <div class="md:col-span-3">
                        <input type="text" name="username" value="{{ old('username') }}" required placeholder="Username akun"
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-2">
                    ...
                    <div class="md:col-span-3">
                        <input type="text" name="jabatan" value="{{ old('jabatan') }}" placeholder="Contoh: Staff IT / Supervisor Komersial"
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-2">
                    ...
                    <div class="md:col-span-3 flex items-center space-x-1.5">
                        <input type="text" readonly :value="selectedEmployeeName" placeholder="Pilih Pegawai / Employee (Opsional)..."
                    ...
                    <div class="p-4 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="approval_authority[rab_limit]" value="100000000"
                            ...
                            <div>
                                ...
                                <input type="number" name="approval_authority[invoice_limit]" value="100000000"
                                       class="w-full px-3.5 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl font-mono text-slate-800 dark:text-slate-100">
                            </div>
                        </div>
                    </div>
