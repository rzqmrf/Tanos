                        ...
                        <td class="py-3.5 px-3 text-center whitespace-nowrap">
                            <div class="inline-flex items-center space-x-1.5">
                                ...
                                <a href="{{ route('users.show', $item->id) }}"
                                   ...
                                   class="p-2 rounded-lg hover:opacity-90 transition shadow-2xs flex items-center justify-center" title="View User">
                                ...
                                <a href="{{ route('users.edit', $item->id) }}"
                                   ...
                                   class="p-2 rounded-lg hover:opacity-90 transition shadow-2xs flex items-center justify-center" title="Edit User">
                                ...
                                <form action="{{ route('users.destroy', $item->id) }}" method="POST" class="inline"
                                    ...
                                    <button type="submit" 
                                            ...
                                            class="p-2 rounded-lg hover:opacity-90 transition shadow-2xs flex items-center justify-center cursor-pointer" title="Delete User">
