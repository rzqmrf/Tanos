...
<div class="space-y-6" x-data="{ showModal: false, editMode: false, form: { id: null, code: '', name: '', description: '', active: true } }">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-1.5 font-medium">Kelola data referensi {{ $categoryTitle }} untuk sistem pengelolaan Tenaga Alih Daya (TAD) Pelindo Group.</p>
        </div>
