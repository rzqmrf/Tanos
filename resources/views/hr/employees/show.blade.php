    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-sm">
        <div>
            ...
            <div class="flex items-center space-x-2 text-xs font-bold text-slate-400 dark:text-slate-500 mb-1.5">
                ...
                <span>/</span>
                <a href="{{ route('employees.index') }}" class="hover:text-primary transition">Employee</a>
                <span>/</span>
    ...
    <div class="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl shadow-sm overflow-hidden" x-data="{ activeTab: 'general_info' }">
        ...
        <div class="p-6">
            ...
            <div x-show="activeTab === 'employee_identity'" class="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs font-semibold" style="display: none;">
                ...
                <div>
                    <label class="block text-slate-600 dark:text-slate-400 mb-1.5 font-bold">Sub Regional</label>
            ...
            <div x-show="activeTab === 'custom_date'" class="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs font-semibold" style="display: none;">
                ...
                <div>
                    <label class="block text-slate-600 dark:text-slate-400 mb-1.5 font-bold">No BPJS Kesehatan</label>
                    <input type="text" disabled value="{{ $employee->bpjs_kesehatan_number ?? '-' }}"
                        class="w-full px-3.5 py-2.5 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-mono font-bold cursor-not-allowed">
                </div>
                <div>
                    <label class="block text-slate-600 dark:text-slate-400 mb-1.5 font-bold">No BPJS Ketenagakerjaan</label>
