...
<div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    ...
    <div class="flex items-center gap-2">
        ...
        <button id="btn-open-create" onclick="document.getElementById('modal-create-employee').classList.remove('hidden')"
            class="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-4 py-2.5 rounded-xl text-xs font-semibold shadow-md shadow-blue-500/20 transition cursor-pointer">
