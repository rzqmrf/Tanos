...
<div class="space-y-6 w-full" x-data="bankAcsManager()">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <!-- Breadcrumbs: / Bank ACS / Bank ACS / Index -->
            <div class="flex items-center space-x-2 text-xs font-semibold text-slate-400 dark:text-slate-400 mb-2">
                ...
                <span>Bank ACS</span>
                <span class="text-slate-300 dark:text-slate-600">/</span>
                <span class="font-bold text-slate-700 dark:text-slate-200">Bank ACS</span>
                <span class="text-slate-300 dark:text-slate-600">/</span>
                <span class="text-slate-400 dark:text-slate-500">Index</span>
            </div>
        ...
        <div class="flex items-center gap-2.5 self-start sm:self-auto">
            <button @click="openCreate()"
                    class="px-3.5 py-2.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-bold rounded-xl transition flex items-center space-x-1.5 cursor-pointer">
                        ...
                        <tr class="hover:bg-slate-50/70 dark:hover:bg-slate-800/30 transition">
                            ...
                            <td class="py-3.5 px-4 text-center">
                                <div class="flex items-center justify-center space-x-1.5">
                                    <!-- 1. Blue Detail / Inquiry Button -->
                                    <button type="button" @click="openInquiryModal({{ json_encode($item) }}, {{ $loop->iteration }})"
