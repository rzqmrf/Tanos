    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <div class="flex items-center space-x-2 text-xs font-bold text-slate-400 dark:text-slate-500 mb-1.5">
                ...
                <span>/</span>
                <span class="text-primary font-black">Bank ACS Customer</span>
            </div>

            <h1 class="text-2xl font-black text-slate-800 dark:text-slate-100 tracking-tight">
                Bank ACS Customer / Partner
            </h1>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5 font-medium">Rekening Bank Auto Collection System (ACS) dan rekening tujuan kliring penagihan billing invoice.</p>
        </div>
