                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                        ...
                        <td class="px-5 py-4 text-center">
                            <div class="flex items-center justify-center gap-1.5">
                                ...
                                {{-- Green Edit Button --}}
                                <button onclick="openEditModal({{ $item->id }}, '{{ addslashes($item->document_type) }}', '{{ addslashes($item->customer) }}', '{{ addslashes($item->project_code) }}', '{{ addslashes($item->project_name) }}')" 
...
<script>
function openEditModal(id, docType, customer, pCode, pName) {
    document.getElementById('form-edit-peo').action = '/dashboard/peo-settings/' + id;
    document.getElementById('edit-document_type').value = docType;
    document.getElementById('edit-customer').value = customer;
    document.getElementById('edit-project_code').value = pCode;
    document.getElementById('edit-project_name').value = pName;
