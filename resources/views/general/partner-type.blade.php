...
<div class="space-y-6" x-data="{ 
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-1.5 font-medium">Klasifikasi segmentasi rekanan bisnis, vendor alih daya, pelanggan, serta afiliasi BUMN.</p>
        </div>
