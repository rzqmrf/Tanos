                        ...
                        <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-800/20">
                            ...
                            <td class="py-3 px-4 text-center">
                                <form action="{{ route('general.partner.banks.destroy', [$partner->id, $bank->id]) }}" method="POST" class="inline"
                                    ...
                                    @method('DELETE')
                                    <button type="submit" 
                                            class="p-2 rounded-lg bg-rose-600 hover:bg-rose-700 text-white transition shadow-2xs inline-flex items-center justify-center cursor-pointer" title="Hapus">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
                                    </button>
                                </form>
                            </td>
