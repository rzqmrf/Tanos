        ...
        <form action="{{ route('general.partner.update', $partner->id) }}" method="POST" class="space-y-6 text-xs">
            ...
            <div class="pt-2">
                ...
                <textarea name="description" rows="3" required
                          class="w-full p-3.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-800 dark:text-slate-100 focus:ring-2 focus:ring-primary/20 focus:outline-none leading-relaxed">{{ old('description', $partner->description ?? $partner->name) }}</textarea>
            </div>
