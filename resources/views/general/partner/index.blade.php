                    ...
                    <tr class="hover:bg-slate-50/70 dark:hover:bg-slate-800/40 transition">
                        ...
                        <td class="py-3.5 px-3 text-center whitespace-nowrap">
                            <div class="inline-flex items-center space-x-1.5">
                                <!-- View Button (Blue with magnifying glass) -->
                                <a href="{{ route('general.partner.show', $item->id) }}"
                                   style="background-color: #0091ea; color: #ffffff;"
                                   class="p-2 rounded-lg hover:opacity-90 transition shadow-2xs flex items-center justify-center" title="View Partner">
                                ...
                                <a href="{{ route('general.partner.edit', $item->id) }}"
                                   ...
                                   class="p-2 rounded-lg hover:opacity-90 transition shadow-2xs flex items-center justify-center" title="Edit Partner">
                                ...
                                <form action="{{ route('general.partner.destroy', $item->id) }}" method="POST" class="inline"
                                    ...
                                    <button type="submit" 
                                            ...
                                            class="p-2 rounded-lg hover:opacity-90 transition shadow-2xs flex items-center justify-center cursor-pointer" title="Delete Partner">
