    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <div class="flex items-center space-x-2 text-xs font-bold text-slate-400 dark:text-slate-500 mb-1.5">
                ...
                <span>Master FA</span>
                <span>/</span>
                <span class="text-primary font-black">Cost Center</span>
            </div>

            <h1 class="text-2xl font-black text-slate-800 dark:text-slate-100 tracking-tight">
                Cost Center Master (Pusat Biaya)
            </h1>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5 font-medium">Pengelompokan akun beban, departemen pelaksana, dan pembebanan anggaran ke Profit Center.</p>
        </div>
