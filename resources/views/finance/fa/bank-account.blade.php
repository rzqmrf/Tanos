    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <div class="flex items-center space-x-2 text-xs font-bold text-slate-400 dark:text-slate-500 mb-1.5">
                ...
                <span>Master FA</span>
                <span>/</span>
                <span class="text-primary font-black">Bank Account</span>
            </div>

            <h1 class="text-2xl font-black text-slate-800 dark:text-slate-100 tracking-tight">
                Company Bank Accounts
            </h1>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5 font-medium">Master rekening bank kas operasional, penerimaan invoice billing, payroll, dan pemetaan akun buku besar (GL CoA).</p>
        </div>
