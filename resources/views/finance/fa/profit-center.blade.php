    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <div class="flex items-center space-x-2 text-xs font-bold text-slate-400 dark:text-slate-500 mb-1.5">
                ...
                <span>Master FA</span>
                <span>/</span>
                <span class="text-primary font-black">Profit Center</span>
            </div>

            <h1 class="text-2xl font-black text-slate-800 dark:text-slate-100 tracking-tight">
                Profit Center Master (Pusat Laba)
            </h1>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5 font-medium">Pengelolaan unit bisnis, divisi profit, dan segmen pendapatan korporasi & proyek.</p>
        </div>
