...
<div class="space-y-6" x-data="{ 
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-sm">
        <div>
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-1 font-medium">Pengelompokan akun buku besar (General Ledger) untuk laporan Neraca (Balance Sheet) & Laba Rugi (Income Statement).</p>
        </div>
