                            ...
                            <td class="py-3.5 px-4 text-center">
                                <div class="flex items-center justify-center space-x-1.5">
                                    ...
                                    <button @click="openEdit({{ json_encode($item) }})"
                                            ...
                                            class="p-2 rounded-lg hover:opacity-90 transition shadow-2xs flex items-center justify-center cursor-pointer" title="Edit Group">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-3.5 h-3.5">
                                    ...
                                    @if($item->accounts_count == 0)
                                        <form method="POST" action="{{ route('fa.account-group.destroy', $item->id) }}" onsubmit="return confirm('Hapus Account Group ini?');" class="inline">
                                            ...
                                            <button type="submit" 
                                                    ...
                                                    class="p-2 rounded-lg hover:opacity-90 transition shadow-2xs flex items-center justify-center cursor-pointer" title="Hapus Group">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-3.5 h-3.5">
