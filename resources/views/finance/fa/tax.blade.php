...
<div class="space-y-6" x-data="{ 
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2.5 font-medium">Pengaturan tarif PPN, PPh 21 Tenaga Kerja, PPh 23 Jasa, dan PPh Final 4(2) untuk transaksi invoice & RAB proyek.</p>
        </div>
                            ...
                            <td class="py-3.5 px-4 text-center">
                                <div class="flex items-center justify-center space-x-1.5">
                                    ...
                                    <button @click="openEdit({{ json_encode($item) }})"
                                            ...
                                            class="p-2 rounded-lg hover:opacity-90 transition shadow-2xs flex items-center justify-center cursor-pointer" title="Edit Pajak">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-3.5 h-3.5">
                                    ...
                                    <form method="POST" action="{{ route('fa.tax.destroy', $item->id) }}" onsubmit="return confirm('Hapus tarif pajak ini?');" class="inline">
                                        ...
                                        <button type="submit" 
                                                ...
                                                class="p-2 rounded-lg hover:opacity-90 transition shadow-2xs flex items-center justify-center cursor-pointer" title="Hapus Pajak">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-3.5 h-3.5">
