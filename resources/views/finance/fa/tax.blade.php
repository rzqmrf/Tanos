    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <div class="flex items-center space-x-2 text-xs font-bold text-slate-400 dark:text-slate-500 mb-1.5">
                ...
                <span>Master FA</span>
                <span>/</span>
                <span class="text-primary font-black">Tax Master</span>
            </div>

            <h1 class="text-2xl font-black text-slate-800 dark:text-slate-100 tracking-tight">
                Tax Master (Tarif Pajak)
            </h1>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5 font-medium">Pengaturan tarif PPN, PPh 21 Tenaga Kerja, PPh 23 Jasa, dan PPh Final 4(2) untuk transaksi invoice & RAB proyek.</p>
        </div>
