...
<div class="space-y-6" x-data="{ 
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-1.5 font-medium">Struktur bagan akun hierarkis terpadu untuk integrasi jurnal voucher, posting payroll, dan sinkronisasi SAP General Ledger.</p>
        </div>
