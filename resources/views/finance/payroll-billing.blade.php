    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <div class="flex items-center space-x-2 text-xs font-bold text-slate-400 dark:text-slate-400 mb-4.5">
                ...
                <span class="text-slate-300 dark:text-slate-600">/</span>
                <span class="text-primary dark:text-sky-400 font-black">Payroll Tagihan</span>
            </div>

            <h1 class="text-2xl font-black text-slate-800 dark:text-slate-100 tracking-tight">
                Payroll Tagihan Tenaga Alih Daya (TAD)
            </h1>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2.5 font-medium">Pengelolaan penagihan payroll TAD ke pelanggan/prinsipal, penerbitan Pranota, dan posting Billing ke SAP AR.</p>
        </div>

        <div class="flex items-center gap-2">
            <button onclick="window.print()" class="px-4 py-2.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 text-slate-700 dark:text-slate-200 text-xs font-bold rounded-xl shadow-xs transition flex items-center space-x-1.5 cursor-pointer">
                ...
                <div class="space-y-3 text-xs">
                    ...
                    <div class="space-y-1.5 pt-2">
                        ...
                        <div class="flex justify-between py-1 border-b border-slate-100 dark:border-slate-800">
                            ...
                            <span class="font-mono font-semibold" x-text="'Rp ' + ((selectedItem.allowances + selectedItem.overtime) || 0).toLocaleString('id-ID')"></span>
                        </div>
                        <div class="flex justify-between py-1 border-b border-slate-100 dark:border-slate-800">
